...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  var game = new Game();
	  ReactDOM.render(React.createElement(GameBox, { title: 'The Dart Scorer App', game: game }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype = {
	  ...
	  changeThrower: function changeThrower() {
	  ...
	  playerThrow: function playerThrow(score) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Player.prototype = {
	  throwDarts: function throwDarts(playerThrow) {
...
/***/ function(module, exports) {
	...
	var Throw = function Throw(score) {
	  this.score = score;
	};
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', placeholder: 'Player 1',
	...
	var PlayerScoreBox = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var scores = this.props.player.scores.map(function (score, index) {
	      return React.createElement(
	        'li',
	        { className: 'strikeThrough', key: index },
	        score
	      );
	    });
	    return React.createElement(
